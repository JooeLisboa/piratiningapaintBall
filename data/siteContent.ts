...
export const siteContent = {
  ...
  testimonials: [
    {
      quote:
        "Campo bacana, equipe proativa e equipamentos em excelente estado.",
    },
    {
      quote:
        "Espaço top, tivemos uma experiência muito boa, voltaremos com toda certeza.",
    },
  ...
  galleryImages: [
    {
      ...
      alt: "Equipe pronta para partida",
  ...
  pricing: [
    {
      ...
      price: "R$45,00",
      description:
        "com 100 bolinhas, 1h30min de jogo com todo equipamento incluso:",
  ...
  notices: [
    ...
    },
    {
      ...
      description:
        "Dúvidas sobre modalidades e partidas especiais devem ser consultadas com a equipe.",
    },
    {
      title: "Área especial adicional",
      description:
        "A área especial próxima ao campo oficial pode ser consultada diretamente com a arena.",
    },
