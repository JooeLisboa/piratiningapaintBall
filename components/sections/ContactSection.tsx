...
export function ContactSection() {
  return (
    <AnimatedSection id="contato" className="container-max py-16">
      <SectionTitle title="Contato" description="Fale com nossa equipe e confirme seu agendamento com rapidez." />
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="space-y-4">
          ...
          <a href={buildWhatsAppUrl('Olá! Quero agendar uma partida na Arena Paintball - Piratininga PaintBall.')} target="_blank" rel="noopener noreferrer" className="btn-primary shadow-brand">Agendar pelo WhatsApp</a>
        </div>
        <BookingForm />
      </div>
    </AnimatedSection>
